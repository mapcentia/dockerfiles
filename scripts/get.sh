...
curl  https://raw.githubusercontent.com/mapcentia/dockerfiles/master/scripts/vidi/stop.sh --create-dirs -o $PWD/scripts/vidi/start.sh
curl  https://raw.githubusercontent.com/mapcentia/dockerfiles/master/scripts/vidi/build.sh --create-dirs -o $PWD/scripts/vidi/update.sh
