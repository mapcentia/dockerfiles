...
curl  https://raw.githubusercontent.com/mapcentia/dockerfiles/master/scripts/gc2/migrate.sh --create-dirs -o $PWD/scripts/gc2/stop.sh
...
curl  https://raw.githubusercontent.com/mapcentia/dockerfiles/master/scripts/vidi/update.sh --create-dirs -o $PWD/scripts/vidi/update.sh
